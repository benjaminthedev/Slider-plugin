<?php
/*
Plugin Name: Wonder Slider Free - DO NOT UPDATE
...
define('WONDERPLUGIN_SLIDER_VERSION', '11.2');
...
define('WONDERPLUGIN_SLIDER_PLUGIN_VERSION', '11.2');
...
class WonderPlugin_Slider_Plugin {
	...
	function register_menu()
	{
		...
		$menu = add_menu_page(
				__('Wonder Slider', 'wonderplugin_slider'),
				__('Wonder Slider', 'wonderplugin_slider'),
				$userrole,
