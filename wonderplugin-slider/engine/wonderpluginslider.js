 ...
 * Version 11.2 
 * 
 * I have edited this file as I do not want a water mark on the theme!
 */
(function ($) {
    ...
    $.fn.wonderpluginslider = function (options) {
        ...
        AmazingSlider.prototype = {
            ...
            playVideo: function (autoplay) {
                ...
                if (autoplay && this.options.playmutedandinlinewhenautoplay &&
            ...
            playMp4Video: function (href, webmhref,
                ...
                if (ASPlatforms.isIE10() && this.options.forceflashonie10 ||
                    ASPlatforms.isIE11() && this.options.forceflashonie11) isHTML5 = false;
                if (isHTML5) {
                    var videoSrc = href;
                    if (ASPlatforms.isFirefox() || ASPlatforms.isOpera())
            ...
            embedHTML5Video: function ($container, src, autoPlay, muted, playsinline) {
                if (ASPlatforms.isFirefox() && this.options.nativecontrolsonfirefox || (ASPlatforms.isIE6789() || ASPlatforms.isIE10() ||
                    ASPlatforms.isIE11()) && this.options.nativecontrolsonie || ASPlatforms.isIPhone() && this.options.nativecontrolsoniphone || ASPlatforms.isIPad() && this.options.nativecontrolsonipad || ASPlatforms.isAndroid() && this.options.nativecontrolsonandroid) this.options.nativehtml5controls = true;
                if (ASPlatforms.isIOS() || ASPlatforms.isAndroid()) this.options.nativecontrolsonfullscreen = true;
                $container.html("<div class='amazingslider-video-container-" + this.id + "' style='position:relative;display:block;width:100%;height:100%;'><video class='slider-inline-video' style='width:100%;height:100%;'" +
                    (this.options.nativehtml5controls && !this.options.videohidecontrols ? " controls='controls'" : "") + (this.options.nativecontrolsnodownload ? " controlsList='nodownload'" : "") + (muted ? " muted" : "") + (playsinline ? " playsinline" : "") + "></div>");
                $("video", $container).get(0).setAttribute("src", src);
                if (autoPlay) $("video", $container).get(0).play();
                if (!this.options.nativehtml5controls && !this.options.videohidecontrols) {
                    $("video", $container).data("src", src);
                    $("video", $container).asHTML5VideoControls(this.options.skinsfolder,
                        this, ".slider-inline-video", this.options.videohidecontrols, this.options.videohideplaybutton, muted ? 0 : this.options.defaultvideovolume, this.options.nativecontrolsonfullscreen, this.options.nativecontrolsnodownload, null)
                }
                var instance = this;
                $("video", $container).off("ended").on("ended", function () {
                    instance.videoPaused = false;
            ...
            playVimeoVideo: function (href, autoplay, muted, playsinline) {
                ...
                if (this.options.previewmode) {
                    ...
                    var src = href + (href.indexOf("?") < 0 ? "?" : "&") + "autoplay=" + (autoplay && !ASPlatforms.isAndroid() ? "1" : "0") + (muted ? "&muted=1" :
                        "") + (playsinline ? "&playsinline=1" : "") + "&api=1&player_id=amazingslider_vimeo_" + this.id;
            ...
            resizeSlider: function () {
                ...
                if (this.options.isfullscreen) {
                    ...
                    if ($(".amazingslider-img-elem-" + this.id).length >
                        0) this.resizeFullscreenImage($(".amazingslider-img-elem-" + this.id))
                } else {
                ...
                if (this.options.navmultirows && this.options.navdirection == "horizontal" && this.options.navthumbresponsivemode == "samecolumn") {
                    var $bullets = $(".amazingslider-bullet-" +
                ...
                if (this.options.navthumbnavigationstyle != "auto") {
                    ...
                    if (this.options.navstyle == "thumbnails" && this.options.navthumbresponsive) {
                        ...
                        if (this.options.navposition == "bottomleft" || this.options.navposition == "bottomright" || this.options.navposition == "bottom" || this.options.navposition ==
                            "right") p += bulletPos;
                        if (this.options.navdirection == "vertical") {
                            $carLeftArrow.css({
                            ...
                            $carLeftArrow.css({
                                left: this.options.navthumbnavigationstyle == "arrowoutside" ? "-" + this.options.navthumbnavigationarrowimagewidth +
                                    "px" : "0px",
                                top: "0px",
                                "margin-top": p + "px"
                            });
